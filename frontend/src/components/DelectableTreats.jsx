...
import delect from "../JsonFiles/delectabletreats.js";

const Delectdish = () => {
  const scrollRef = useRef(null);
  const navigate = useNavigate();
  const limitedItems = delect.products.slice(0, 5);
...
const updateArrows = () => {
  ...
  return (
    <section className="my-4 mx-3 py-4 relative max-w-6xl lg:mx-auto">
      {/* Title */}
      <h2 className="text-xl font-semibold">{delect.name}</h2>
      <p className="text-gray-600 mb-4">{delect.subText}</p>
